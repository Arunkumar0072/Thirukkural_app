...
export default function AramDescription2({navigation,route}) { 
//this commented line dont want please check your mobile volume first
//     useEffect(()=>
//     {
...
//     },[])
    ...
    let description=(lang==='Tamil'?array:lang==='English'?englisharray:array).find(e=>e.desc.find(e=>e.count===variable))
    ...
    { 
      if(variable<380){
      navigation.navigate('AramDescription2',{variable:(variable+1),lang:lang})
      }else{
        navigation.navigate('PoorulDescription2',{variable:(381),lang:lang})
      }
    }
...
function changeiconsincrease()
{
  ...
  return (
    <View style={{width:width,height:height}} className='  items-center'>
        ...
        <View style={{width:width,height:height*.12,backgroundColor:'#620100'}} className='px-2 bg-blue-400 space-y-1 justify-around'>
        ...
        <View style={{width:width,height:height*.07}} className='mt-1 flex-row  items-center justify-evenly '>
