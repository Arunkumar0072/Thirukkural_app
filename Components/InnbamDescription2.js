...
export default function InnbamDescription2({navigation,route}) {
    ...
    let description=(lang==='Tamil'?Innbamarray:lang==='English'?InnbamEnglisharray:Innbamarray).find(e=>e.desc.find(e=>e.count===variable))
    ...
    {
        if(variable<1330){
            navigation.navigate('InnbamDescription2',{variable:(variable+1),lang:lang})
        }else{
            navigation.navigate('InnbamDescription2',{variable:(1330),lang:lang})
        }
    }
    function handlepageingdecrease() 
    {
        ...
        navigation.navigate('InnbamDescription2',{variable:(variable-1),lang:lang})
            ...
            navigation.navigate('PoorulDescription2',{variable:(1080),lang:lang})
        }
    }
...
function changeiconsincrease()
{
  ...
  return (
    <View style={{width:width,height:height}} className='  items-center'>
        ...
        <View style={{width:width,height:height*.12,backgroundColor:'#620100'}} className='px-2 space-y-1 justify-around'>
            ...
            { 
               ...
               <View style={{width:width*.95}} className='bg-white mb-2'>
                ...
                <View style={{width:width*.95}} className='bg-white mb-2'>
                    ...
                    <Text className='px-2 py-2 text-base leading-6 font-semibold text-black'>{lang==='Tamil'?dp.translate:dp.option1}</Text>
